...
$MESS["SOA_TEMPL_SUM_SUMMARY_ITEMS"] = "Items:";
...
$MESS["SOA_TEMPL_ORDER_COMPLETE"] = "Your order complete, thanks!";
...
//$MESS["SOA_TEMPL_PAY_PDF"] = "Click <a href=\"#LINK#\" target=\"_blank\">Download invoice</a> to get the invoice in PDF format.";счет на оплату check.pdf (срок поставки в течение 1 дн€ после оплаты)
$MESS["SOA_TEMPL_PAY_PDF"] = "- счет на оплату <a href=\"#LINK#\">check.pdf</a> (срок поставки в течение #DAYS# дней после оплаты)";  
...
$MESS["QUANTITY_PACK"] = "Quantity in pack";
$MESS["SHIPMENT_TERMS"] = "Shipment terms";
$MESS["PRICE_UNIT"] = "Price/unit";
$MESS["PRICE"] = "Price";
$MESS["PRINT_LINK"] = "Print Version";
$MESS["SOA_TEMPL_DAYS"] = "within #DAYS# days after payment execution";
$MESS['UNIT'] = "pcs.";

$MESS["SOA_TEMPL_PREDZAKAZ"] = "(Pre-order)";
$MESS["THANKU_MESS"] = "Dear client! You will receive the order confirmation from УArgosЦTradeФ to the e-mail address you provided . A copy of your pre-order form will be attached to the mail.";

$MESS["SOA_TEMPL_ZAKAZ"] = "processed ";
$MESS["SOA_TEMPL_ZAKAZ_ADD"] = "is a copy of a ЂConfirmation of orderї";

$MESS["SOA_TEMPL_PAY_PDF"] = "- a bill <a href=\"#LINK#\">check.pdf</a> (will be deliverd within #DAYS# days after payment execution)";


$MESS["PROP_COMP_NAME"] = "Company name;";
$MESS["PROP_CONTACT"] = "Contact person;";
$MESS["PROP_PHONES"] = "One of the two phone numbers ;";
$MESS["PROP_DELIVERY_BLOCK"] = "Section \"Shipping and Delivery\";";

$MESS["PROP_CONTACT_DATA"] = "Contacts";

$MESS["CONF_CONTACT_DATA"] = "Contacts";
$MESS["CONF_COMP"] = "Company";
$MESS["CONF_CONT_PERSON"] = "Contact person";
$MESS["CONF_PHONE_WORK"] = "Phone <span>(work)</span>";
$MESS["CONF_PHONE_MOB"] = "Phone <span>(mobile)</span>";
$MESS["CONF_FAX"] = "Fax";
$MESS["CONF_WEB"] = "Web-site";
$MESS["CONF_COMP_ADDR"] = "Company address";

$MESS["CONF_DELIVERY_DATA"] = "Delivery";
$MESS["CONF_DELIVERY_ADDR"] = "Delivery address";

$MESS["PROPS_REQUIRED"] = "All fields marked with an asterisk are required for pre-order processing";
$MESS["PROPS_IF_REQ"] = "If marked fields are filled in:";
$MESS["PROPS_ELSE_REQ"] = "Then your request is qualified as pre-order";
$MESS["PROP_COMMENT"] = "Once EXW or FCA are selected for Shipping your invoice is created automatically. Your order is validated once all the marked fields are filled out. In case of other shipping methods a pre-order will be placed.";

$MESS["TO_BASKET"] = "Back to cart";
$MESS["TO_CONFIRM"] = "Go to order confirmation";

$MESS["CONFIRM_TITLE"] = "Confirmation";

$MESS["SELECT"] = "Select file";

$MESS["CHECK_DATA"] = "Please, check the information";
$MESS["DELIVERY_COMMENT"] = "Your comments";

$MESS["CHANGE"] = "Correct data";
$MESS["DELIVERY_CHOISE"] = "If you select any delivery except EXW, order sum will increase by delivery cost";
?>