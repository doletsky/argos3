...
<!-- Vertical menu -->
  ...
  <div class="content_right">				 		 
    <h1> 			<?
			...
			$ar_result=CIBlockElement::GetList(Array("SORT"=>"ASC"), Array("IBLOCK_ID"=>33, "CODE"=>"technical_information", "ACTIVE"=>"Y", "PROPERTY_LANG_VALUE"=>"RUS"), Array("NAME"));
    ...
    <div class="include_area_page"> 			<?
			...
			$ar_result=CIBlockElement::GetList(Array("SORT"=>"ASC"), Array("IBLOCK_ID"=>33, "CODE"=>"technical_information", "ACTIVE"=>"Y", "PROPERTY_LANG_VALUE"=>"RUS"), Array("DETAIL_TEXT","CODE","ACTIVE","PROPERTY_LANG"));
			if($ar_fields=$ar_result->GetNext())
			{
			...
			//Вывод pdf-файлов
			$ar_result=CIBlockElement::GetList(Array("SORT"=>"ASC"), Array("IBLOCK_ID"=>33, "CODE"=>"technical_information", "ACTIVE"=>"Y", "PROPERTY_LANG_VALUE"=>"RUS"), Array("PROPERTY_PDF_FILES"));
      ...
      <div class="images_block_about"> 				<?
				...
				$ar_result=CIBlockElement::GetList(Array("SORT"=>"ASC"), Array("IBLOCK_ID"=>33, "CODE"=>"technical_information", "ACTIVE"=>"Y", "PROPERTY_LANG_VALUE"=>"RUS"), Array("PROPERTY_IMG_FILES"));			
				while($ar_fields=$ar_result->GetNext())
				{
