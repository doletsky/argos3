...
<p>
	<div class="title_req"><?echo GetMessage("subscr_conf_code")?><span class="starrequired">*</span></div>
	<input class="input_style" type="text" name="CONFIRM_CODE" value="<?echo $arResult["REQUEST"]["CONFIRM_CODE"];?>" size="20" />
</p>
<p><?echo GetMessage("subscr_conf_date")?> <?echo $arResult["SUBSCRIPTION"]["DATE_CONFIRM"];?></p><br>
<input class="submit_style" type="submit" name="confirm" value="<?echo GetMessage("subscr_conf_button")?>" />
<?/*
