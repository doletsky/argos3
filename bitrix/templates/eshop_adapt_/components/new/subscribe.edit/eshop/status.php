...
<form action="<?=$arResult["FORM_ACTION"]?>" method="get">
	<div class="title"><?echo GetMessage("subscr_title_status")?></div>
	...
	<?endif;?>
	<div style="margin-top: 20px;"><span class="title_req"><?echo GetMessage("subscr_act")?> </span><?echo ($arResult["SUBSCRIPTION"]["CONFIRMED"] == "Y"? GetMessage("subscr_yes"):GetMessage("subscr_no"));?></div>
	<div style="margin-top: 20px;"><span class="title_req"><?echo GetMessage("subscr_conf")?> </span><?echo ($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y"? GetMessage("subscr_yes"):GetMessage("subscr_no"));?></div>
	<div style="margin-top: 20px;"><span class="title_req"><?echo GetMessage("adm_id")?> </span><?echo $arResult["SUBSCRIPTION"]["ID"];?></div>
	<div style="margin-top: 20px;"><span class="title_req"><?echo GetMessage("subscr_date_add")?> </span><?echo $arResult["SUBSCRIPTION"]["DATE_INSERT"];?></div>
	<?if($arResult["SUBSCRIPTION"]["CONFIRMED"] == "Y"):?>
		<?if($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y"):?>
			<input style="margin-top: 20px;" class="submit_style" type="submit" name="unsubscribe" value="<?echo GetMessage("subscr_unsubscr")?>" />
			<input type="hidden" name="action" value="unsubscribe" />
		<?else:?>
			<input style="margin-top: 20px;" class="submit_style" type="submit" name="activate" value="<?echo GetMessage("subscr_activate")?>" />
