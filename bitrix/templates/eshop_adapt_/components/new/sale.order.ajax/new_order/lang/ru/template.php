...
$MESS['SOA_TEMPL_H'] = "Оформление заказа";
...
$MESS['SOA_TEMPL_SUM_SUMMARY_ITEMS'] = "Товаров всего:";
...
$MESS['SOA_TEMPL_ORDER_COMPLETE'] = "Ваш заказ оформлен, спасибо!";
...
$MESS["QUANTITY_PACK"] = "Количество <br>в упаковке";
$MESS['SHIPMENT_TERMS'] = "Условия отгрузки";
$MESS['PRICE_UNIT'] = "Цена за шт.";
$MESS['PRICE'] = "Стоимость";
$MESS['PRINT_LINK'] = "Печатная версия";
$MESS["SOA_TEMPL_DAYS"] = "в течение #DAYS# дней после оплаты";
$MESS["SOA_TEMPL_PAY_PDF"] = "- счет на оплату <a href=\"#LINK#\">check.pdf</a> (срок поставки в течение #DAYS# дней после оплаты)";
$MESS["SOA_TEMPL_PREDZAKAZ"] = "(Предзаказ)";

$MESS["SOA_TEMPL_ZAKAZ"] = "оформленный Вами ";
$MESS["SOA_TEMPL_ZAKAZ_ADD"] = "это копия печатной версии «подтверждение заказа»";

$MESS["THANKU_MESS"] = "Уважаемый клиент, на Ваш e-mail отправлено письмо, подтверждающее получение компанией «Аргос-Трейд» Вашего заказа, а также к письму прикреплен(ы) сформированные Вами документы:";

$MESS["PROP_COMP_NAME"] = "Юр. Лицо;";
$MESS["PROP_CONTACT"] = "Контактное лицо;";

$MESS["CONF_CONTACT_DATA"] = "Контактные данные";
$MESS["CONF_COMP"] = "Юр. лицо <span>(в соответствие с Уставом)</span>";
$MESS["CONF_CONT_PERSON"] = "Контактное лицо";
$MESS["CONF_PHONE_WORK"] = "Телефон <span>(рабочий)</span>";
$MESS["CONF_PHONE_MOB"] = "Телефон <span>(моб.)</span>";
$MESS["CONF_FAX"] = "Факс";
$MESS["CONF_WEB"] = "Сайт";
$MESS["CONF_COMP_ADDR"] = "Юридический адрес";

$MESS["CONF_DELIVERY_DATA"] = "Доставка";
$MESS["CONF_DELIVERY_ADDR"] = "Адрес доставки";

$MESS["PROP_PHONES"] = "Один из двух телефонов;";
$MESS["PROP_DELIVERY_BLOCK"] = "Блок \"Доставка\";";
$MESS["PROPS_REQUIRED"] = "Отмечены обязательные поля, необходимые для оформления предзаказа";
$MESS["PROPS_IF_REQ"] = "Если заполнены только обязательные поля:";
$MESS["PROPS_ELSE_REQ"] = "то, статус оформляемого документа будет:<br/>предзаказ.";
$MESS["PROP_COMMENT"] = "Если будут заполнены все поля \"Сайт\" и \"Комментарии\", то при условии отгрузки в течении 1 рабочего дня после оплаты будет автоматически выписан счет.";

$MESS["TO_BASKET"] = "Вернуться в корзину";
$MESS["TO_CONFIRM"] = "Перейти к подтверждению";

$MESS["CONFIRM_TITLE"] = "Подтвеждение заказа";

$MESS["SELECT"] = "Выберите файл";

$MESS["CHECK_DATA"] = "Проверьте, пожалуйста, правильность данных";
$MESS["DELIVERY_COMMENT"] = "Комментарий для отправки";

$MESS["CHANGE"] = "Изменить данные";
$MESS["DELIVERY_CHOISE"] = "При выборе условий доставки, кроме EXW стоимость товара в инвойсе увеличивается на стоимость доставки";
?>