...
//$MESS["SOA_TEMPL_PAY_PDF"] = "Click <a href=\"#LINK#\" target=\"_blank\">Download invoice</a> to get the invoice in PDF format.";счет на оплату check.pdf (срок поставки в течение 1 дня после оплаты)
...
$MESS["THANKU_MESS"] = "Dear client! You will receive the order confirmation from “Argos–Trade” to the e-mail address you provided . A copy of your pre-order form will be attached to the mail.";

$MESS["SOA_TEMPL_ZAKAZ"] = "processed ";
$MESS["SOA_TEMPL_ZAKAZ_ADD"] = "is a copy of a «Confirmation of order»";
