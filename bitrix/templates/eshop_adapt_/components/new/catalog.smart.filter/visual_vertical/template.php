					...
					<div class="bx_filter_parameters_box active">
						...
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container">
								...
								<div class="bx_filter_parameters_box_container_block right_block">
				...
				<div class="bx_filter_block">
					<div class="bx_filter_parameters_box_container">
						...
						<div class="bx_filter_popup_result <?=$arParams["POPUP_POSITION"]?>" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> style="display: inline-block;">
                            ...
                            <input class="bx_filter_search_button" type="submit" onclick="location.href='<?echo $arResult["FILTER_URL"]?>'" value="<?=GetMessage("CT_BCSF_SET_FILTER")?>"  />
