                            ...
                            switch ($INPUT_TYPE):
                                ...
                                case "N":
                                    for ($i = 0; $i < $inputNum; $i++) {
                                        ...
                                        <input class="<? echo $inputNum > 1 ? 'multiinput' : '' ?>" type="text" name="PROPERTY[<?= $propertyID ?>][<?= $i ?>]" prop="<?= $propertyID ?>" arpos="<?= $i ?>" size="25" value="<?= $value ?>" />
                                        <div id="search_wrapper_<?= $i ?>" class="search_wrapper"></div>

                                        <? //if($arResult["PROPERTY_LIST_FULL"][$propertyID]['HINT']) echo '<div class="hint">'.$arResult["PROPERTY_LIST_FULL"][$propertyID]['HINT'].'</div>';?>
                                    ...
                                    if ($inputNum > 1) {
                                        ?><input type="button" value="" class="portfolio_add"><?
                                        }
                                        break;
                                    ...
                                    case "F":
                                        for ($i = 0; $i < $inputNum; $i++) {
                                            ...
                                            if ($propertyID == 'DETAIL_PICTURE') {
                                                echo '<div class="hint">' . GetMessage("ADD_PIC") . '</div>';
                                            }
                                            ?>						

                                        <div class="add_file_btn pseudo_inp_file">
                                            <span class="sel_f"><?= GetMessage("SEL_F") ?></span>
