...
<?if($arResult['VOTE']['ACTIVE']!='N') {?>
<?
if($arResult["VOTE"]["ID"]==2 || $arResult["VOTE"]["ID"]==8 || $arResult["VOTE"]["ID"]==9 || $arResult["VOTE"]["ID"]==1 || $arResult["VOTE"]["ID"]==3 || $arResult["VOTE"]["ID"]==4)
	$voting_id='voting_1';
if($arResult["VOTE"]["ID"]==10 || $arResult["VOTE"]["ID"]==11 || $arResult["VOTE"]["ID"]==12 || $arResult["VOTE"]["ID"]==5 || $arResult["VOTE"]["ID"]==6 || $arResult["VOTE"]["ID"]==7)
	$voting_id='voting_2';
?>
<div class="sideblock_wrap">
<div class="voting-form-box sidebar_block" id="voting" pos="<?=$voting_id?>" page="<?=$page?>">
...
?>
	<div class="title vote-item-title vote-item-question"><?=$arQuestion["QUESTION"]?><?if($arQuestion["REQUIRED"]=="Y"){echo "<span class='starrequired'>*</span>";}?></div>
...
<?
			switch ($arAnswer["FIELD_TYPE"]):
					case 0://radio?>						
						<span class="vote-answer-item vote-answer-item-radio vote">
							...
							<label class="radio_text" for="vote_radio_<?=$arAnswer["QUESTION_ID"]?>_<?=$arAnswer["ID"]?>"><?=$arAnswer["MESSAGE"]?></label>
						</span>
<?
					break;
					case 1://checkbox?>
...
<div class="vote-form-box-buttons vote-vote-footer">
	<span class="vote-form-box-button vote-form-box-button-first"><input type="submit" name="vote" value="<?=GetMessage("VOTE_SUBMIT_BUTTON")?>" class="submit_style main" /></span>
