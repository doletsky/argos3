...
<div id="breadcrumb" class="bx_breadcrumbs">
    <ul>
		<li><a class="main" href="'.SITE_DIR.'"></a><span class="separate">/</span></li>';
...
for($index = 0, $itemSize = $num_items; $index < $itemSize; $index++)
{
	...
	if($arResult[$index]["LINK"] <> "" && $index != $itemSize-1)
		$strReturn .= '<li><a href="'.$arResult[$index]["LINK"].'" title="'.$title.'">'.$title.'</a><span class="separate">/</span></li>';
	else
		$strReturn .= '<li><span class="current">'.$title.'</span></li>';
}
