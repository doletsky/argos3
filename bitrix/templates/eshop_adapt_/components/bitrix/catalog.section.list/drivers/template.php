...
?>
	...
	<tr>
	<td class="header_big version bg_207" rowspan="3">ВЕРСИЯ</td>
	<td class="header_big bg_29" colspan="6">ВИД ИПС</td>
	</tr>
	<tr>
					...
					<table>				
					<tr><td class="header_middle">Чертеж</td><td class="header_middle ">Фото</td></tr>
					<tr class="img">
						<td class="">
					...
					<tr>
						<td class="header_middle " colspan="2">Наименование для заказа</td>
					</tr>
					</table>
					...
					<tr class="links">
						...
						<td colspan="2">
							<table>
								...
								<tr>
								<?php endif;?>
								<td class="<?php if($offersCnt <=2):?>big<?php endif;?><?php if($offersCntPrev > $offersCnt):?> big2<?php endif;?>"><a href="<?php echo $offer['DETAIL_PAGE_URL']?>" target="_blank"><?php echo $offer['NAME']?></a></td>
								<?php endforeach;?>
								<?php if($offersCnt % 2 != 0):?>
								<td>&nbsp;</td>
								<?php endif;?>
								<?php 
									$offersCntPrev = $offersCnt;
								?>
								</tr>
							</table>
						</td>
