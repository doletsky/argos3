		...
		<?foreach($arResult["SEARCH"] as $arItem):?>
			...
			<div class="news_wrap">
				<div class="news_content">
					<a href="<?echo $arItem["URL_WO_PARAMS"];/*str_replace('/news/','/news/newsletter/',$arItem["URL_WO_PARAMS"])*/?>" class="news_title"><?echo $arItem["TITLE_FORMATED"]?></a>
					<div class="news_anons"><?echo $arItem["BODY_FORMATED"]?></div>
					<a href="<?echo $arItem["URL_WO_PARAMS"]; /*str_replace('/news/','/news/newsletter/',$arItem["URL_WO_PARAMS"])*/?>" class="reed_more"><?=GetMessage("REED_MORE")?></a>
				</div>
				<div class="news_footer">
					<div class="news_date"><?$date=explode(' ',$arItem["DATE_FROM"]);$date=explode('-',$date[0]);echo $date[2].'.'.$date[1].'.'.$date[0];?></div>
					<div class="clear"></div>
				</div>
			</div>
