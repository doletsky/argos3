<?
//Получаем свойств заказа по id и свойства платёжной системы
...
$months = array('Января','Февраля','Марта','Апреля','Мая','Июня','Июля','Августа','Сентября','Октября','Декабря');
...
if($order){
	...
	if (!$blank && GetParam('PATH_TO_STAMP', $PSinfo))
		$pdf->Image(GetParam('PATH_TO_STAMP', $PSinfo), $margin['left']+40, $pdf->GetY());
