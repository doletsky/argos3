...
function getCountryByIp2($ipAddress)
{
	$ipDetail=array();
...
$ipDetail = getCountryByIp2($IP);//получение страны по ip

if(CModule::IncludeModule("iblock")){
	//Получение id секции по названию секции
	$ar_result2=CIBlockSection::GetList(Array("SORT"=>"ASC"), Array("IBLOCK_ID"=>$arParams["IBLOCK_ID"], "UF_REGION_CODE"=>$ipDetail));
	if($res2=$ar_result2->GetNext())
	{
		$reg_ip_url=$res2['SECTION_PAGE_URL'];
	}
}

?>
<?
//Редирект на страну, определенную по geoip
header('Location: '.$reg_ip_url);
?>
