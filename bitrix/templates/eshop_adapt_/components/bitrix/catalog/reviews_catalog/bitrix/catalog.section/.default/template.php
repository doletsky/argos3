...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	if($arItem['PROPERTIES']['CATALOG_TYPE']['VALUE_XML_ID']=='OTHER') {/*?>
		<p class="text_page_info_2">Нажмите для быстрого перехода к группе</p>
				<div class="tabs_simple_style">
					<div class="tab_simple_style tab_1 current"><span class="s_15">Cерия Люкс</span></div>
					<div class="tab_simple_style tab_2"><span class="s_15">Cерия Стандарт</span></div>
					<div class="tab_simple_style tab_3"><span class="s_15">Cерия Эконом</span></div>
					<div class="tab_simple_style tab_4"><span class="s_15">Cерия Эконом 2</span></div>
				</div>
				<div class="catalog_item_wrap">
					<h2 class="catalog_category">Cерия Люкс</h2>
					<div class="catalog_category_description">Общие характеристики: Патрон G23 для компактных люминесцентных ламп (КЛЛ) типа TC-S, 2pin, накладной, вывод проводов к тыльной стороне, крепление на винты (вертикально или горизонтально или на основание), PC</div>
					<div class="catalog_item">
						<div class="catalog_item_img"><img src="/bitrix/templates/eshop_adapt_/images/new_images/katalog_epr_img.jpg" /><div class="btn_lupa"></div></div>
						<div class="catalog_item_description">Электронный пускорегулирующий аппарат LST КЛЛ 11 Б.ТП Предназначен для работы с лампой типа PL-S 11W/4p; Оптимальные параметры запуска лампы обеспечивают долгий срок работы; Световые пульсации менее 5%</div>
						<div class="clear"></div>
					</div>
					<div class="catalog_item_properties">
						<div class="properties_wrap modification">
							<div class="properties_title">Модификации</div>
						...
						<div class="properties_wrap features">
							<div class="properties_title">Технические характеристики</div>
							<div class="properties_content">
								- ЭПРА защищен от высоковольтных импульсов в сети<br>- При отказе лампы автоматически происходит выключение балласта. После замены лампы балласты перезапускаются через выключение и повторное включение светильника<br>-  Для светильников класса защиты I (металлический корпус)<br>-  Степень защиты IP20
							</div>
						</div>
						<div class="clear"></div>
					</div>
	...
	<?*/}?>
	<pre><?//print_r($arItem['PROPERTIES']['CATALOG_TYPE']['VALUE_XML_ID'])?></pre>
