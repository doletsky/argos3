...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	if ('Y' == $arParams['SHOW_DISCOUNT_PERCENT'] && 0 < $arItem['MIN_PRICE']['DISCOUNT_DIFF_PERCENT'])
	{
	?>
	...
	?><div class="bx_catalog_item_title sim-height"><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $productTitle; ?>"><? echo $productTitle; ?></a></div>
	...
	?></div></div>
    <span class="skidka">Скидки в зависимости от объема</span>
    <?
