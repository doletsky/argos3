                    ...
                    if ('Y' == $arParams['USE_PRODUCT_QUANTITY']) {
                        ...
                        <div class="item_buttons vam">
                            <span class="item_buttons_counter_block">
                                ...
                                <input id="<? echo $arItemIDs['QUANTITY']; ?>" type="text" class="tac transparent_input" value="<?
                            ...
                            <span class="item_buttons_counter_block">
                                <a href="javascript:void(0);" class="bx_big bx_bt_blue bx_cart" id="<? echo $arItemIDs['BUY_LINK']; ?>"><span></span><?
                                    ...
                                    if ('Y' == $arParams['DISPLAY_COMPARE']) {
                                        ?>
                                    <a href="javascript:void(0)" class="bx_big bx_bt_white bx_cart" style="margin-left: 10px"><?
                        ...
                        <div class="item_buttons vam">
                            <span class="item_buttons_counter_block">
                                <a href="javascript:void(0);" class="bx_big bx_bt_blue bx_cart" id="<? echo $arItemIDs['BUY_LINK']; ?>"><span></span><?
                                    ...
                                    if ('Y' == $arParams['DISPLAY_COMPARE']) {
                                        ?>
                                    <a id="<? echo $arItemIDs['COMPARE_LINK']; ?>" href="javascript:void(0)" class="bx_big bx_bt_white bx_cart" style="margin-left: 10px"><?
                                        echo ('' != $arParams['MESS_BTN_COMPARE'] ? $arParams['MESS_BTN_COMPARE'] : GetMessage('CT_BCE_CATALOG_COMPARE')
                                        );
                                        ?></a>
                                    <?
