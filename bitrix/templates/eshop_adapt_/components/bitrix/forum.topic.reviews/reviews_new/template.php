...
<div id="news_comments">
        <a name="comments"></a>
	<div class="news_comments_title"><?=GetMessage('SENT_COMMENT')?></div>					
	<div id="news_comments_form">
		<div class="news_comments_tabs">
			<div class="news_comments_tab current tab_1" id="tab_1"><span><?=GetMessage('COMMENT_POST')?></span></div>
			<div class="news_comments_tab tab_2" id="tab_2"><span>Вконтакте</span></div>
			<div class="news_comments_tab tab_3" id="tab_3"><span>Facebook</span></div>
			<div class="news_comments_tab tab_4" id="tab_4"><span>LiveJournal</span></div>
			<div class="news_comments_tab tab_5" id="tab_5"><span>Twitter</span></div>
			<div class="clear"></div>
		</div>		
<div class="reviews-reply-form news_comments_content c-form_visible" <?=(($arParams['SHOW_MINIMIZED'] == "Y")?'style="display:none;"':'')?> data-tab="tab_1">
...
?>
	<div class="reviews-reply-fields">
		<div class="reviews-reply-field-user">
			<div class="field_title"><?=GetMessage('F_NAME')?> *</div>
...
?>
			...
			<div class="reviews-reply-field-setting">
				<input type="checkbox" name="TOPIC_SUBSCRIBE" id="TOPIC_SUBSCRIBE<?=$arParams["form_index"]?>" value="Y" <?=($arResult["TOPIC_SUBSCRIBE"] == "Y")? "checked disabled " : "";?> tabindex="<?=$tabIndex++;?>" />
				<label class="pseudo_check marg_check news" for="TOPIC_SUBSCRIBE<?=$arParams["form_index"]?>"><?=GetMessage('NEWS_AGREEMENT')?></label>
			</div>
<?
//endif;
?>
	...
	<div class="reviews-reply-field reviews-reply-field-text">
		<div class="field_title"><?=GetMessage('OPINION_TEXT')?></div>
		<div class="field_text">
...
?>
		<div class="reviews-reply-field reviews-reply-field-captcha">
			...
			<div class="field_title"><?=GetMessage('CAPTCHA')?> *</div>
			<img src="/bitrix/tools/captcha.php?captcha_code=<?=$arResult["CAPTCHA_CODE"]?>" class="captcha" alt="<?=GetMessage("F_CAPTCHA_TITLE")?>" />
			<div class="field_text">
				<input class="min" type="text" size="30" name="captcha_word" tabindex="<?=$tabIndex++;?>" autocomplete="off" />
			</div>
			<div class="clear"></div>
...
<div class="reviews-reply-form news_comments_content" data-tab="tab_2">
...
<div class="reviews-reply-form news_comments_content" data-tab="tab_3">
	<div class="fb-comments" data-href="<?=$url?>" data-width="690" data-numposts="10" data-colorscheme="light"></div>
</div>

<div class="reviews-reply-form news_comments_content" data-tab="tab_4">

</div>

<div class="reviews-reply-form news_comments_content" data-tab="tab_5">
...
<div class="reviews-block-container reviews-reviews-block-container">
	<div class="reviews-block-outer">
		<div id="new_comments" class="news_comments_wrap">
			<div class="news_comments_header"><?=GetMessage("OPINIONS_TITLE")?> (<?=$arResult['ELEMENT']['PRODUCT']['PROPERTY_FORUM_MESSAGE_CNT_VALUE']?>)</div>
<?
...
foreach ($arResult["MESSAGES"] as $res):
	$iCount++;
?>
	<table cellspacing="0" border="0" class="news_comments_one reviews-post-table <?=($iCount == 1 ? "reviews-post-first " : "")?><?
		...
		<div class="news_comments_date"><?=$res["POST_DATE"]?></div>
	...
	<tbody>
	<tr><td>
		<div class="news_comments_message" id="message_text_<?=$res["ID"]?>"><?=$res["POST_MESSAGE_TEXT"]?></div>
		<a href="#review_anchor" style='margin-left:0;' title="<?=GetMessage("F_NAME")?>"  class="news_comments_answer reviews-button-small" onclick="return reply2author('<?=$res["FOR_JS"]["AUTHOR_NAME"]?>');">Ответить</a>
<?
