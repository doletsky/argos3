...
<div class="pseudo_select"><?=GetMessage("SECTIONS_CATALOG_TITLE");?></div>
<ul class="vertical_menu_catalog<?if ($wizTemplateId == "eshop_vertical_popup"):?> popup<?endif?>">
<?
	$previousLevel = 0;
	foreach($arResult as $key => $arItem):
		...
		$ser_id='';
		$catalog_list_view=0;
		$arFilter1=array("IBLOCK_ID"=>$iBlock,"NAME"=>$arItem["TEXT"], "CODE"=>$symCode);//id инфоблока и id секции
