<div id="content" class="whole multi">
	...
	<div class="tabs_grey_style">
		...
		/*END*/
		?>
		<a<?if($inactive_class!="inactive") {?> href="?tab=4&multimedia=1"<?}?> class="tab_grey_style tab_1<?if(isset($_GET['tab']) && $_GET['tab']=='4' && isset($_GET['multimedia']) && $_GET['multimedia']=='1' || isset($_GET['tab']) && $_GET['tab']=='4' && !isset($_GET['multimedia']) && $resArr["photos"]==true)echo' current'?>"><span class="s_15 <?=$inactive_class?>"><?=GetMessage("MULTIMEDIA_PHOTOS");?></span></a>
		<?
			$inactive_class="inactive";
			if($arResult['PROPERTIES']['MULTIMEDIA_PROMOTIONAL_MATERIALS']['VALUE']) {
				$inactive_class="";
			}
		?>
		<a<?if($inactive_class!="inactive") {?> href="?tab=4&multimedia=2"<?}?> class="tab_grey_style tab_2<?if(isset($_GET['tab']) && $_GET['tab']=='4' && isset($_GET['multimedia']) && $_GET['multimedia']=='2' && $inactive_class!="inactive" || isset($_GET['tab']) && $_GET['tab']=='4' && !isset($_GET['multimedia']) && $resArr["promo"]==true)echo' current'?>"><span class="s_15 <?=$inactive_class?>"><?=GetMessage("MULTIMEDIA_MATERIALS");?></span></a>
		<?
			$inactive_class="inactive";
		...
		?>		
		<a <?if($inactive_class!="inactive") {?> href="?tab=4&multimedia=5"<?}?> class="tab_grey_style tab_5<?if(isset($_GET['tab']) && $_GET['tab']=='4' && isset($_GET['multimedia']) && $_GET['multimedia']=='5')echo' current'?>"><span class="s_15 <?=$inactive_class?>"><?=GetMessage("MULTIMEDIA_BANNERS");?></span></a>
	</div>
