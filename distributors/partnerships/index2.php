					...
					<div class="descriptions">
						...
						while($res2=$ar_result2->GetNext())
						{
							...
							<div class="affiliates_wrap">
								...
								<div class="address_wrap">-->
									...
									<a href="<?=$arEl["DETAIL_PAGE_URL"];?>/?ID_DEST=<?=$res2['ID']?>" class="LinkDest"><?=$arEl["NAME"];?></a> 
						...
						<?  if ($count==1) {?>
							<div id="affiliates">
									...
									<?	
									if(CModule::IncludeModule('catalog')){
										$arElReg = CCatalogProduct::GetByIDEx($res['PROPERTY_CML2_LINK_VALUE']);	
									}?>
									<a href="<?=$arElReg["DETAIL_PAGE_URL"];?>/?ID_DEST=<?=$res['ID']?>" class="LinkDest"><?=$arElReg["NAME"];?></a> 
									</div>
							</div>	
						<? }?>
